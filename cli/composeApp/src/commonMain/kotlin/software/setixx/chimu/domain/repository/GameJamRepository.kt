...
interface GameJamRepository {
    val allJams: Flow<List<GameJam>>

    val selectedJam: Flow<GameJamDetails?>
    ...
    suspend fun forceJamStatus(jamId: String, targetStatus: GameJamStatus): ApiResult<GameJamDetails>
}